...
Generate content for section `section-11-youth-page` (filename: `section-11-youth-page.md`).
...
for `section-11-youth-page` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-11-youth-page.md`
