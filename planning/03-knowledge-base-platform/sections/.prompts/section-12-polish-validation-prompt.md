...
Generate content for section `section-12-polish-validation` (filename: `section-12-polish-validation.md`).
...
for `section-12-polish-validation` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-12-polish-validation.md`
