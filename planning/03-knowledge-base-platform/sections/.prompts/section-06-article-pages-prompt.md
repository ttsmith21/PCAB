...
Generate content for section `section-06-article-pages` (filename: `section-06-article-pages.md`).
...
for `section-06-article-pages` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-06-article-pages.md`
