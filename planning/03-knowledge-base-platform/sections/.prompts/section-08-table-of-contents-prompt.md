...
Generate content for section `section-08-table-of-contents` (filename: `section-08-table-of-contents.md`).
...
for `section-08-table-of-contents` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-08-table-of-contents.md`
