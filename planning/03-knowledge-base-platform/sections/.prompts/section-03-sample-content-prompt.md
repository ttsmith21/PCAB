...
Generate content for section `section-03-sample-content` (filename: `section-03-sample-content.md`).
...
for `section-03-sample-content` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-03-sample-content.md`
