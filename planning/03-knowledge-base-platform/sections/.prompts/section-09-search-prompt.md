...
Generate content for section `section-09-search` (filename: `section-09-search.md`).
...
for `section-09-search` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-09-search.md`
