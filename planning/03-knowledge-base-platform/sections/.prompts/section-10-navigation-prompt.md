...
Generate content for section `section-10-navigation` (filename: `section-10-navigation.md`).
...
for `section-10-navigation` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-10-navigation.md`
