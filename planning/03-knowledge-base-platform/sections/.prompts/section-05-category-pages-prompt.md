...
Generate content for section `section-05-category-pages` (filename: `section-05-category-pages.md`).
...
for `section-05-category-pages` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-05-category-pages.md`
