...
Generate content for section `section-07-category-filters` (filename: `section-07-category-filters.md`).
...
for `section-07-category-filters` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\knowledge-base-platform\planning\03-knowledge-base-platform/sections/section-07-category-filters.md`
