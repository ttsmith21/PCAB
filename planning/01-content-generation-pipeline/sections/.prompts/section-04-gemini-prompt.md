...
Generate content for section `section-04-gemini` (filename: `section-04-gemini.md`).
...
for `section-04-gemini` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-04-gemini.md`
