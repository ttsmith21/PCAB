...
Generate content for section `section-08-output` (filename: `section-08-output.md`).
...
for `section-08-output` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-08-output.md`
