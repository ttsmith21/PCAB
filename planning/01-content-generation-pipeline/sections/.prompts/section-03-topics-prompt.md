...
Generate content for section `section-03-topics` (filename: `section-03-topics.md`).
...
for `section-03-topics` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-03-topics.md`
