...
Generate content for section `section-02-prompts` (filename: `section-02-prompts.md`).
...
for `section-02-prompts` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-02-prompts.md`
