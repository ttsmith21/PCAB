...
Generate content for section `section-06-validation` (filename: `section-06-validation.md`).
...
for `section-06-validation` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-06-validation.md`
