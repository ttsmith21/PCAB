...
Generate content for section `section-07-orchestration` (filename: `section-07-orchestration.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `C:\GitHub\PCAB\planning\01-content-generation-pipeline/claude-plan.md` - Full implementation plan
2. `C:\GitHub\PCAB\planning\01-content-generation-pipeline/claude-plan-tdd.md` - Test stubs for each section
3. `C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-orchestration` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-07-orchestration.md`
