...
Generate content for section `section-05-claude` (filename: `section-05-claude.md`).
...
for `section-05-claude` to understand what this section should contain.
...
`C:\GitHub\PCAB\planning\01-content-generation-pipeline/sections/section-05-claude.md`
