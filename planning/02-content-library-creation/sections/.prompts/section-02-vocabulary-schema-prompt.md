...
Generate content for section `section-02-vocabulary-schema` (filename: `section-02-vocabulary-schema.md`).
...
for `section-02-vocabulary-schema` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\content-library-deep-plan\planning\02-content-library-creation/sections/section-02-vocabulary-schema.md`
