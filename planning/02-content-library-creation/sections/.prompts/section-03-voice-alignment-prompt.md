...
Generate content for section `section-03-voice-alignment` (filename: `section-03-voice-alignment.md`).
...
for `section-03-voice-alignment` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\content-library-deep-plan\planning\02-content-library-creation/sections/section-03-voice-alignment.md`
