...
Generate content for section `section-06-health-safety` (filename: `section-06-health-safety.md`).
...
for `section-06-health-safety` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\content-library-deep-plan\planning\02-content-library-creation/sections/section-06-health-safety.md`
