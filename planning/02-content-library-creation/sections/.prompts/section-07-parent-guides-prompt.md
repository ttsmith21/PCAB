...
Generate content for section `section-07-parent-guides` (filename: `section-07-parent-guides.md`).
...
for `section-07-parent-guides` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\content-library-deep-plan\planning\02-content-library-creation/sections/section-07-parent-guides.md`
