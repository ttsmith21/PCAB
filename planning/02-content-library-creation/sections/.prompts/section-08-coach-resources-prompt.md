...
Generate content for section `section-08-coach-resources` (filename: `section-08-coach-resources.md`).
...
for `section-08-coach-resources` to understand what this section should contain.
...
`C:\GitHub\PCAB\.claude\worktrees\content-library-deep-plan\planning\02-content-library-creation/sections/section-08-coach-resources.md`
