...
Generate content for section `section-04-site-wide-ctas` (filename: `section-04-site-wide-ctas.md`).
...
for `section-04-site-wide-ctas` to understand what this section should contain.
...
`C:\Users\tsmith\OneDrive - Northern Manufacturing Co., Inc\Documents\GitHub\PC-Boosters-Web\docs\plans\02-communication-hub/sections/section-04-site-wide-ctas.md`
