...
Generate content for section `section-05-build-verification` (filename: `section-05-build-verification.md`).
...
for `section-05-build-verification` to understand what this section should contain.
...
`C:\Users\tsmith\OneDrive - Northern Manufacturing Co., Inc\Documents\GitHub\PC-Boosters-Web\docs\plans\02-communication-hub/sections/section-05-build-verification.md`
