...
Generate content for section `section-03-buy-button` (filename: `section-03-buy-button.md`).
...
for `section-03-buy-button` to understand what this section should contain.
...
`C:\Users\tsmith\OneDrive - Northern Manufacturing Co., Inc\Documents\GitHub\PC-Boosters-Web\docs\plans\03-payment-integration/sections/section-03-buy-button.md`
