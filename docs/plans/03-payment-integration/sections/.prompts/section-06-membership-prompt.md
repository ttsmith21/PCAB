...
Generate content for section `section-06-membership` (filename: `section-06-membership.md`).
...
for `section-06-membership` to understand what this section should contain.
...
`C:\Users\tsmith\OneDrive - Northern Manufacturing Co., Inc\Documents\GitHub\PC-Boosters-Web\docs\plans\03-payment-integration/sections/section-06-membership.md`
