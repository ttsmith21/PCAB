...
Generate content for section `section-02-hover-migrations` (filename: `section-02-hover-migrations.md`).
...
for `section-02-hover-migrations` to understand what this section should contain.
...
`C:\Users\tsmith\OneDrive - Northern Manufacturing Co., Inc\Documents\GitHub\PC-Boosters-Web\docs\plans\01-brand-color-scheme/sections/section-02-hover-migrations.md`
