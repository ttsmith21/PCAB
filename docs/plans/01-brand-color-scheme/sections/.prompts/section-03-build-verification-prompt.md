...
Generate content for section `section-03-build-verification` (filename: `section-03-build-verification.md`).
...
for `section-03-build-verification` to understand what this section should contain.
...
`C:\Users\tsmith\OneDrive - Northern Manufacturing Co., Inc\Documents\GitHub\PC-Boosters-Web\docs\plans\01-brand-color-scheme/sections/section-03-build-verification.md`
